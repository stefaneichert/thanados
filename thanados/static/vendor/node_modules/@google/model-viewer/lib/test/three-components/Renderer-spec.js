...
async function createScene() {
    ...
    if (context instanceof CanvasRenderingContext2D) {
        ...
        context.transferFromImageBitmap = (...args) => {
            scene.renderCount++;
            transferFromImageBitmap.call(context, ...args);
        };
    }
    else {
        throw new Error('context is neither a CanvasRenderingContext2D nor an ImageBitmapRenderingContext.');
    }
    return scene;
}
suite('Renderer', () => {
