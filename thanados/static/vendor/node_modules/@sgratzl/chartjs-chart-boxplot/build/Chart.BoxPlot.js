(function (global, factory) {
  ...
  function quantilesType7(arr) {
    return quantilesInterpolate(arr, function (a, b, alpha) {
      return a + alpha * (b - a);
    });
  }
  /**
  ...
  function quantilesLinear(arr) {
    return quantilesInterpolate(arr, function (i, j, fraction) {
  ...
  function quantilesLower(arr) {
    return quantilesInterpolate(arr, function (i) {
      return i;
    });
  }
  /**
  ...
  function quantilesHigher(arr) {
    return quantilesInterpolate(arr, function (_, j) {
      return j;
    });
  }
  /**
  ...
  function quantilesMidpoint(arr) {
    return quantilesInterpolate(arr, function (i, j) {
      return (i + j) * 0.5;
    });
  }
  /**
  ...
  function determineStatsOptions(options) {
    ...
    var quantiles = determineQuantiles(q);
    return {
      coef: coef,
      quantiles: quantiles
    };
