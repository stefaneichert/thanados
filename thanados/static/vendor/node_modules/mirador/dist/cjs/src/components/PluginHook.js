...
var PluginHook = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
  ...
  return PluginComponents ? PluginComponents.map(function (PluginComponent, index) {
    return (// eslint-disable-line react/prop-types
      ...
      /*#__PURE__*/
      _react["default"].isValidElement(PluginComponent) ? /*#__PURE__*/_react["default"].cloneElement(PluginComponent, _objectSpread(_objectSpread({}, otherProps), {}, {
        ref: ref
      })) : /*#__PURE__*/_react["default"].createElement(PluginComponent, Object.assign({
        ref: ref
      }, otherProps, {
